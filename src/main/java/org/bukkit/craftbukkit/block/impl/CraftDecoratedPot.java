...
public final class CraftDecoratedPot extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.DecoratedPot, org.bukkit.block.data.Directional, org.bukkit.block.data.Waterlogged {
    ...
    public org.bukkit.block.BlockFace getFacing() {
        return get(CraftDecoratedPot.FACING, org.bukkit.block.BlockFace.class);
    }

    @Override
    public void setFacing(org.bukkit.block.BlockFace facing) {
        set(CraftDecoratedPot.FACING, facing);
    }

    @Override
    public java.util.Set<org.bukkit.block.BlockFace> getFaces() {
        return getValues(CraftDecoratedPot.FACING, org.bukkit.block.BlockFace.class);
    }
    ...
    public boolean isWaterlogged() {
        return get(CraftDecoratedPot.WATERLOGGED);
    }

    @Override
    public void setWaterlogged(boolean waterlogged) {
        set(CraftDecoratedPot.WATERLOGGED, waterlogged);
    }
}
