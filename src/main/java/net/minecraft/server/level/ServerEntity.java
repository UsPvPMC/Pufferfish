...
public class ServerEntity {
    ...
    private Stream<Entity> changedPassengers(List<Entity> passengers, List<Entity> lastPassengers) {
        return Stream.concat(lastPassengers.stream().filter((entity) -> {
            return !passengers.contains(entity);
        }), passengers.stream().filter((entity) -> {
