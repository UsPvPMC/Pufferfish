    ...
    protected void updateTrades() {
        ...
        if (avillagertrades_imerchantrecipeoption != null && avillagertrades_imerchantrecipeoption1 != null) {
            if (this.level.enabledFeatures().contains(FeatureFlags.UPDATE_1_20)) {
                VillagerTrades.ItemListing[] avillagertrades_imerchantrecipeoption2 = (VillagerTrades.ItemListing[]) VillagerTrades.WANDERING_TRADER_TRADES_1_20.get(1);

                if (avillagertrades_imerchantrecipeoption2 != null) {
                    avillagertrades_imerchantrecipeoption = (VillagerTrades.ItemListing[]) ArrayUtils.addAll(avillagertrades_imerchantrecipeoption, avillagertrades_imerchantrecipeoption2);
                }
            }
