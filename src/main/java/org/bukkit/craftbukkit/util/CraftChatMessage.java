...
public final class CraftChatMessage {
    ...
    private static final class StringMessage {
                ...
                case 1:
                    ...
                    if (c == 'x') {
                        ...
                        if (this.hex.length() == 7) {
                            this.modifier = StringMessage.RESET.withColor(TextColor.parseColor(this.hex.toString()));
                            this.hex = null;
                        }
        ...
        private void appendNewComponent(int index) {
            Component addition = Component.literal(this.message.substring(currentIndex, index)).setStyle(modifier);
