...
public class ShapedRecipe implements CraftingRecipe {
    ...
    public ShapedRecipe(ResourceLocation id, String group, CraftingBookCategory category, int width, int height, NonNullList<Ingredient> input, ItemStack output, boolean showNotification) {
        this.id = id;
        this.group = group;
    ...
    public static Item itemFromJson(JsonObject json) {
        ...
        Item item = (Item) BuiltInRegistries.ITEM.getOptional(new ResourceLocation(s)).orElseThrow(() -> {
