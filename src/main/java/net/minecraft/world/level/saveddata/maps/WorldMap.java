...
public class WorldMap extends PersistentBase {
    ...
    public WorldMap scaled(int i) {
        return createFresh((double) this.centerX, (double) this.centerZ, (byte) MathHelper.clamp(this.scale + i, 0, 4), this.trackingPosition, this.unlimitedTracking, this.dimension);
    }
