...
public final class CraftPiglinWallSkull extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.Directional {
    ...
    public org.bukkit.block.BlockFace getFacing() {
        return get(CraftPiglinWallSkull.FACING, org.bukkit.block.BlockFace.class);
    }

    @Override
    public void setFacing(org.bukkit.block.BlockFace facing) {
        set(CraftPiglinWallSkull.FACING, facing);
    }

    @Override
    public java.util.Set<org.bukkit.block.BlockFace> getFaces() {
        return getValues(CraftPiglinWallSkull.FACING, org.bukkit.block.BlockFace.class);
    }
}
