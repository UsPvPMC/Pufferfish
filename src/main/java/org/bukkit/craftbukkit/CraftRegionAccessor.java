...
public abstract class CraftRegionAccessor implements RegionAccessor {
    ...
    public void setBiome(int x, int y, int z, Biome biome) {
        ...
        Holder<net.minecraft.world.level.biome.Biome> biomeBase = CraftBlock.biomeToBiomeBase(this.getHandle().registryAccess().registryOrThrow(Registries.BIOME), biome);
