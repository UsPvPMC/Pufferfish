    ...
    public static Object serialize(Tag base) {
        if (base instanceof CompoundTag) {
            ...
            for (String key : ((CompoundTag) base).getAllKeys()) {
                innerMap.put(key, CraftNBTTagConfigSerializer.serialize(((CompoundTag) base).get(key)));
            }
    ...
    public static Tag deserialize(Object object) {
        if (object instanceof Map) {
            ...
            for (Map.Entry<String, Object> entry : ((Map<String, Object>) object).entrySet()) {
                compound.put(entry.getKey(), CraftNBTTagConfigSerializer.deserialize(entry.getValue()));
            }
