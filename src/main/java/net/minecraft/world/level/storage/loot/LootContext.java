...
public class LootContext {
    ...
    LootContext(RandomSource random, float luck, ServerLevel world, Function<ResourceLocation, LootTable> tableGetter, Function<ResourceLocation, LootItemCondition> conditionGetter, Map<LootContextParam<?>, Object> parameters, Map<ResourceLocation, LootContext.DynamicDrop> drops) {
        this.random = random;
        this.luck = luck;
        this.level = world;
    ...
    public static class Builder {
        ...
        public LootContext.Builder withOptionalRandomSeed(long seed, RandomSource random) {
            if (seed == 0L) {
                this.random = random;
            } else {
                this.random = RandomSource.create(seed);
