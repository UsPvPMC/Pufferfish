...
public final class CraftPinkPetals extends org.bukkit.craftbukkit.block.data.CraftBlockData implements org.bukkit.block.data.type.PinkPetals, org.bukkit.block.data.Directional {
    ...
    public int getFlowerAmount() {
        return get(CraftPinkPetals.FLOWER_AMOUNT);
    }

    @Override
    public void setFlowerAmount(int flower_amount) {
        set(CraftPinkPetals.FLOWER_AMOUNT, flower_amount);
    }
    ...
    public org.bukkit.block.BlockFace getFacing() {
        return get(CraftPinkPetals.FACING, org.bukkit.block.BlockFace.class);
    }

    @Override
    public void setFacing(org.bukkit.block.BlockFace facing) {
        set(CraftPinkPetals.FACING, facing);
    }

    @Override
    public java.util.Set<org.bukkit.block.BlockFace> getFaces() {
        return getValues(CraftPinkPetals.FACING, org.bukkit.block.BlockFace.class);
    }
}
