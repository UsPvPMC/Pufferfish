...
public class CraftStructure implements Structure {
    ...
    public void fill(Location origin, BlockVector size, boolean includeEntities) {
        ...
        this.structure.fillFromWorld(((CraftWorld) world).getHandle(), new BlockPos(origin.getBlockX(), origin.getBlockY(), origin.getBlockZ()), new BlockPos(size.getBlockX(), size.getBlockY(), size.getBlockZ()), includeEntities, Blocks.STRUCTURE_VOID);
    }
