...
public class BuiltInRegistries {
    ...
    public static final Registry<MobEffect> MOB_EFFECT = registerSimple(Registries.MOB_EFFECT, (registry) -> {
    ...
    public static final Registry<BlockEntityType<?>> BLOCK_ENTITY_TYPE = registerSimple(Registries.BLOCK_ENTITY_TYPE, (registry) -> {
